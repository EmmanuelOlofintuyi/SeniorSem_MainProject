...
class VocLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        lbl_path = pjoin(self.root, "/content/drive/MyDrive/SeniorSeminar/VOCdevkit/VOC2012/SegmentationClass", im_name + ".png")
        im = Image.open(im_path)
        lbl = torch.from_numpy(np.array(Image.open(lbl_path)))
