...
def build_imageset(filename_txt_path_dictionary, image_folder_path):
...
##image_datasets = {x:datasets.VOCSegmentation('/content/gdrive/MyDrive/SeniorSeminar', download=False, transform=transformations[x]) for x in ['train','val','test']}
...
#Saving the model
MyModel.class_to_idx = im['train'].class_to_idx
MyModel.cpu()
torch.save()